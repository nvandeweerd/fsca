...
This document provides an overview of the `fsca` package.
...
The package contains two functions:
  ...
  - `getUnits()`: a function to facilitate extract of specific units  
...
and dependency parsed with Malt Parser (Nivre, Hall, & Nilsson, 2006).
On the basis of the dependency tags generated by Malt Parser, new
dependency labels were created for the purpose of calculating
phraseological compleixity measures:
...
This modified output was used as the basis of the `fsca` package. An
example (slightly modified for readability) is provided below:
...
``` r
getMeasures(test.sents[sents])$MLS
## [1] 18.73
```
