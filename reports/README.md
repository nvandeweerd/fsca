...
complexity in learner language. For more details see ANONYMOUS (in
press).
...
devtools::install_github("ANONYMOUS/fsca")
library(fsca)
```
...
measures of syntactic complexity (ANONYMOUS, in press). The texts were
POS-tagged with MElt Tagger (Denis & Sagot, 2012) and dependency parsed
with Malt Parser (Nivre, Hall, & Nilsson, 2006).\[1\]
